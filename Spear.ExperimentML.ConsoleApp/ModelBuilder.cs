...
using Spear_ExperimentML.Model;

namespace Spear_ExperimentML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Projects\shay\Spear.Experiment\samples\Spear.MachineLearning.Demo\data\comment.tsv";
        private static string MODEL_FILEPATH = @"../../../../Spear_ExperimentML.Model/MLModel.zip";
