...
namespace Spear_ExperimentML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"D:\Projects\shay\Spear.Experiment\samples\Spear.MachineLearning.Demo\data\comment.tsv";
        ...
        private static ModelInput CreateSingleDataSample(string dataFilePath)
        {
            ...
            ModelInput sampleForPrediction = mlContext.Data.CreateEnumerable<ModelInput>(dataView, false)
                .OrderBy(t => new Random().Next()).First();
